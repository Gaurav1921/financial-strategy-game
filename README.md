...
- **`docs/`** — all project documentation.
  ...
  - [`ENVIRONMENT_SETUP.md`](docs/ENVIRONMENT_SETUP.md) — how the Python
    ...
    project in VS Code.
- **`backend/`** — Python + FastAPI backend. Currently a minimal scaffold
  (`main.py` with a health-check endpoint); this is where round resolution
  and game-state logic will live.
